...
namespace TransactR.Tests
{
    public class DisasterRecoveryTests
    {
        ...
        public DisasterRecoveryTests()
        {
            ...
            var loggerMock = new Mock<ILogger<TransactionalBehaviorBase<TestRequest, TestResponse, SingleStepTestContext, TestState, TestStep>>>();
        ...
        public async Task ExecuteAsync_WhenExceptionIsThrown_ShouldRollbackToCurrentStepByDefault()
        {
            ...
            _mementoStoreMock.Setup(x => x.GetLatestAsync(request.TransactionId, default)).ReturnsAsync((Memento<TestState, TestStep>?)null);
